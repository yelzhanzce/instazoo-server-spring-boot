...
import com.yelzhan.demo.facade.PostFacade;
import com.yelzhan.demo.payload.response.MessageResponse;
import com.yelzhan.demo.service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<Object> createPost(@Valid @RequestBody PostDTO postDTO, BindingResult bindingResult, Principal principal){
        ...
        PostDTO postCreated = postFacade.posToPostDTO(post);
    ...
    public ResponseEntity<List<PostDTO>> getPostsForUser(Principal principal){
